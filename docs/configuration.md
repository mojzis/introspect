...
| `INTROSPECT_REFRESH_INTERVAL_SECONDS` | `600` | web app, stdio MCP | Background refresh poll interval; `0` runs the startup authoritative build once and disables subsequent polling and manual refresh. |
