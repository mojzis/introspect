...
| [Development](https://mojzis.github.io/introspect/development/) | `poe` tasks, the toolbox (`tyf`, `gerenuk`, `biston`, `zorilla`, `pycoati`), the periodic test audit, commit hook, worktrees, building the docs |
